  ...
  const clientFormik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post("/api/clientAuth/register", {
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post("/api/firmAuth/createFirm", {
          ...
          firmCouncilId: values.firmCouncilId,
    ...
    <AuthContainer>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box>
            {formType === "client" ? (
              <ClientSignup clientFormik={clientFormik} />
            ) : (
              <FirmSignup firmFormik={firmFormik} />
            )}
          </Box>
        </Box>
      </Container>
