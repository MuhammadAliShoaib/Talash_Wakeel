...
export default function Work({ image }) {
    return (
        <div style={{ position: 'relative', boxShadow: "rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px", backgroundColor: 'white', textAlign: 'center', padding: '10px', borderRadius: '10px', width: '300px' }}>
